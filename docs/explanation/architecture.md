...
│   ├── physics.py                  # Physical constants (g, R, molar masses…)
│   ├── compute_parameters.py       # Derived parameter computation
│   └── neats_default_parameters.py # Default step-registry names per MRV spec
