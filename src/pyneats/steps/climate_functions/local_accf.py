...
class LocalACCFModel(
    ...
    @staticmethod
    def o3_raw_formula(t: FloatArray,
                       gp: FloatArray) -> FloatArray:
    ...
    def compute_o3(self,
        ...
        try:
            ...
            raise ClimateStepError(f"Unknown ACCF version for O3: {self.params.accf_kwargs['accf_v']}") from e
        
        return accf

    # ---- CH4: raw formula & compute ----
    @staticmethod
    def ch4_raw_formula(gp: FloatArray,
                        fin: FloatArray) -> FloatArray:
        """Returns raw (unscaled, unclamped) P-ATR20-CH4 [K/kg(NOx)]."""

        return -9.83e-13 + 1.99e-18 * gp - 6.32e-16 * fin + 6.12e-21 * gp * fin

    def compute_ch4(self,
                    flight: Flight) -> FloatArray:
        ...
        gp = _as_np(flight[self.params.col_geopotential])
        fin = _fin_rowwise(flight[self.params.col_time], flight[self.params.col_latitude], self.params.solar_constant)
        ...
        try:
            ...
            raise ClimateStepError(f"Unknown ACCF version for CH4: {self.params.accf_kwargs['accf_v']}") from e
    ...
    def compute_h2o(self,
        ...
        try:
            ...
            raise ClimateStepError(f"Unknown ACCF version for H2O: {self.params.accf_kwargs['accf_v']}") from e
